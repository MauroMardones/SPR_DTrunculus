...
```{r Figure1, echo=FALSE, out.width='60%', fig.cap="Sizes compositions from SISO program monitoring krill fishery by strata (BS=Brainsfield Strait, EI= Elephant Island, GS= Gerlache Strait, JOIN= Joinville Island, SSWI= South West). Red line represent recruit size"}
...
```{r Figure4, out.width="70%", fig.cap="Theoretical growth curves for krill based on three SPR sensitivity scenarios that were tested using LBSPR."}
...
```{r Figure5, fig.cap="Fit of the model to the data of lengths in all strata", fig.height=18, fig.width=5}
